    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          {/* Botão Google — fora do Suspense para garantir funcionamento */}
          <div className="mb-5 space-y-3">
            <button
              type="button"
              onClick={() => signIn('google', { callbackUrl: '/dashboard' })}
              className="w-full h-11 flex items-center justify-center gap-3 border border-slate-200 rounded-xl bg-white hover:bg-slate-50 transition-colors text-sm font-semibold text-slate-700 shadow-sm"
            >
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 h-px bg-slate-100" />
              <span className="text-xs text-slate-400">ou use email e senha</span>
              <div className="flex-1 h-px bg-slate-100" />
            </div>
          </div>
